...
Prompts are short-term instructions. Agent contracts, rules, references, actions, and folder structure are the long-term operating memory.
...
5. **Map folder structure**: map the repo's current files into an AI project structure; prefer adding documentation layers before moving production files.
...
- `references/folder-structure-template.md`: use when auditing or proposing project folders.
